###############################################################################
#
# Bash remediation role for the results of evaluation of profile xccdf_org.ssgproject.content_profile_cis_level2_server 
# XCCDF Version:  unknown
#
# Evaluation Start Time:  2025-02-04T05:44:50
# Evaluation End Time:  2025-02-04T05:50:03
#
# This file was generated by OpenSCAP 1.2.17 using:
# 	$ oscap xccdf generate fix --result-id xccdf_org.open-scap_testresult_xccdf_org.ssgproject.content_profile_cis_level2_server --template urn:xccdf:fix:script:sh xccdf-results.xml 
#
